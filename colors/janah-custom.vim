...
highlight StatusLine guifg=#ffaf87 ctermfg=216 guibg=#3a3a3a ctermbg=16 gui=bold,reverse cterm=bold,reverse
highlight StatusLineNC guifg=#808080 ctermfg=244 guibg=#3a3a3a ctermbg=237 gui=NONE cterm=NONE

" Number column {{{1

highlight CursorLineNr guifg=#87afdf ctermfg=110 guibg=#585858 ctermbg=240 gui=NONE cterm=NONE
